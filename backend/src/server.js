...
async function start() {
  ...
  try {
    ...
    // Default subscriptions — all index spots live on IDX_I in Dhan's
    // segment enum (Annexure: IDX_I=0). NIFTY 50=13, BANKNIFTY=25, SENSEX=51.
    // The recorder routes ticks to per-symbol folders by matching
    // (segment, securityId) against symbolRegistry.SYMBOLS so both NIFTY
    // and SENSEX feeds populate their own _NIFTY_50/ and _SENSEX/ folders.
