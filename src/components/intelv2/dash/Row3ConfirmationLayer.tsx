  ...
  return (
    <V2Card title="3.2 Market Breadth">
      ...
      <div className="mt-2.5 flex items-center gap-3">
        <Donut percent={advPct} tone={tone as "bull" | "bear" | "warn"} />
        <div className="flex flex-col">
  ...
  return (
    <V2Card title="3.3 Heavyweights Alignment">
      ...
      <div className="flex flex-1 flex-col gap-1 overflow-y-auto">
        {rows.map((r) => {
          const tone = r.changePct >= 0 ? "bull" : "bear";
          return (
            <div key={r.symbol} className="grid grid-cols-4 px-1 text-[12px]">
              ...
              <span className="text-right font-mono" style={{ color: V2_TONE[tone].color }}>
  ...
  return (
    <V2Card title="3.4 IV / VIX">
      <div className="flex flex-col gap-1.5 text-[12px]">
        ...
        <div className="flex items-center justify-between px-2.5 text-[11px]">
          <span className="text-white/55">IV Expansion</span>
          <V2Pill
            label={iv?.ivRank?.label || "—"}
            tone={iv?.ivRank?.tone as "bull" | "bear" | "warn" | "neutral" || "neutral"}
            size="xs"
          />
        </div>
        <div className="flex items-center justify-between px-2.5 text-[11px]">
