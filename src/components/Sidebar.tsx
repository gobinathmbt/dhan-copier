...
import { Activity, LayoutDashboard, LineChart, Users, ScrollText, LogOut, Wifi, WifiOff, Target, Brain, Radio, Zap, Crosshair, Sigma, GitMerge, TableProperties, Gauge, Compass } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  // { to: "/order-flow", label: "Order Flow Intel Engine (Side-View Logic)", icon: Gauge },
  { to: "/cpr-cam", label: "CPR + Camarilla Power Engine", icon: Compass },
